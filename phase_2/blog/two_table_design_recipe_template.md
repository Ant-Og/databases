...
post, blogger's name, title, content, comment, comment content, commenter's user name
```
...
| Record                | Properties          |
| --------------------- | ------------------  |
| post                  | blogger, title, content
| comment               | username, content

1. Name of the first table (always plural): `posts` 

    Column names: `blogger`, `title`, `content`

2. Name of the second table (always plural): `comments` 

    Column names: `username`, `content`
...
1. **[A] has many [B]** (a Post has many Comments)
2. And on the other side, **[B] belongs to [A]** (a Comment 
belongs to a Post)
3. In that case, the foreign key is in the table [B]
(The foreign key is on the comment table)
